...
class setting:
    ...
    workers = 1
    nepoch = 2
    outf = "C:\PKU\Spring 2022 Intro_to_CV\HM3\code\HM3_PointNet\\results"
    model = ""
    dataset = "C:\PKU\Spring 2022 Intro_to_CV\HM3\code\shapenetcore_partanno_segmentation_benchmark_v0"
